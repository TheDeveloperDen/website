    ...
    , content =
        div [ Tw.bg_opacity_80, Tw.bg_gray_700, Tw.w_full, Tw.flex_1, Tw.text_white, Tw.flex, Tw.flex_col ]
            [ div [ Tw.ml_16, Tw.mr_16 ]
                ...
                , h3 [ class "montserrat", Tw.text_2xl, Tw.py_2 ] [ text "1. Be respectful" ]
                , p [ Tw.pl_16 ]
                ...
                , h3 [ class "montserrat", Tw.text_2xl, Tw.py_2 ] [ text "2. Be patient" ]
                ...
                , h3 [ class "montserrat", Tw.text_2xl, Tw.py_2 ] [ text "3. Use the right channels" ]
                ...
                , h3 [ class "montserrat", Tw.text_2xl, Tw.py_2 ] [ text "4. Don't be annoying" ]
                ...
                , h3 [ class "montserrat", Tw.text_2xl, Tw.py_2 ] [ text "5. Other stuff" ]
